...
but early release bundles did not include them. Version 0.1.6 added the
baseline notices; 0.1.7 completes the Nerd Fonts copyright and MIT notice for
the patched fallback font.
